...
const siteConfig = {
  personal: {
    ...
    description: 'Just Existing\n' +
        ...
        '\n' +
        ,
    tagline: 'I want to sleep',
  location: 'Bangalore, India',
  },

  seo: {
    title: "Jasmeet Kaur- Student of Economics",
    description: 'Official website showcasing Jasmeet\'s education, research, projects and experience.',
  },

  animatedText: ['Student', 'Learner', 'Foodie', 'Existing'],
